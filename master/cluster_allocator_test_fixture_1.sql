...
INSERT INTO msp_errors VALUES (2, 'COMM', 'Error communicating with slave.', 'Get http://test:8081/msp/status: dial tcp 172.21.228.10:8081: i/o timeout');
...
SELECT pg_catalog.setval('msp_errors_id_seq', 2, true);
...
INSERT INTO problems VALUES (3, 'Slave `test` is unreachable', '', 1, '2016-08-29 00:17:45.764054', '2016-08-29 18:30:12.125344', 1, NULL, NULL);
